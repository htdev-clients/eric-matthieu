...
- **D1 database:** `holiday-rentals-db` (id: `YOUR_D1_DATABASE_ID_HERE`) — shared across all client projects, multi-tenant via `property_id`
...
| `PRICE_PER_NIGHT` | `wrangler.toml` | Nightly rate — used server-side to calculate total due |
